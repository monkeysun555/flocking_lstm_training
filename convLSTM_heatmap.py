...
pred_interval_conv1 = Conv2D(filters=32, kernel_size=(kernel_size,kernel_size), padding='same',
    activation='relu', use_bias=True, kernel_initializer='glorot_uniform')
...
model.fit(mygenerator, steps_per_epoch=num_samples/10,epochs=epochs,
